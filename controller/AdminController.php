...
class AdminController
{
    ...
    public function index()
    {
        ...
        $data = [
            ...
            'esMes' => $filtro === 'mes',
            'esAnio' => $filtro === 'anio',
            'seriesTiempoJson' => json_encode($seriesTiempo, JSON_HEX_TAG),
            'usuariosPorPais' => $usuariosPorPais,
            'usuariosPorPaisJson' => json_encode($usuariosPorPais, JSON_HEX_TAG),
            'usuariosPorSexo' => $usuariosPorSexo,
            'usuariosPorSexoJson' => json_encode($usuariosPorSexo, JSON_HEX_TAG),
            'usuariosPorRol' => $usuariosPorRol,
            'usuariosPorRolJson' => json_encode($usuariosPorRol, JSON_HEX_TAG),
            'usuariosPorEdad' => $usuariosPorEdad,
            'usuariosPorEdadJson' => json_encode($usuariosPorEdad, JSON_HEX_TAG),
            'porcentajeCorrectas' => $porcentajeCorrectas,
            'porcentajeCorrectasJson' => json_encode($porcentajeCorrectas, JSON_HEX_TAG),
